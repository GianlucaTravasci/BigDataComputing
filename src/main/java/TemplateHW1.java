...
public class TemplateHW1 {
  ...
  public static void main(String[] args) throws IOException {
    ...
    if (args.length != 2) {
      // se il numero di argomenti è diverso da 2
    ...
    // creo oggetto di configurazione di Spark e ci imposto il nome
    // potrei impostare anche il master ma sarebbe poco flessibile
    // ecco perché lo passo come comando da CLI (in questo caso è nella
    // configurazione del template con -Dspark.master="local[*]")
    // local[*] indica che lavora in modalità locale con tutti i core che trova a disposizione
    ...
    // facciamo una prova di funzionamento
    numdocs = docs.count();
    ...
    // flatMapToPair prende il JavaRDD e ...
    count = docs
